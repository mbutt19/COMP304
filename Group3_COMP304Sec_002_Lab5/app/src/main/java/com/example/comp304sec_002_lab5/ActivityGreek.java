...
public class ActivityGreek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = new Intent(ActivityGreek.this, ActivityGreekMap.class);
        ...
        ListView lv = (ListView)findViewById(R.id.listView_greek);
        final  String[] restNames = getResources().getStringArray(R.array.greek_cuisines);
