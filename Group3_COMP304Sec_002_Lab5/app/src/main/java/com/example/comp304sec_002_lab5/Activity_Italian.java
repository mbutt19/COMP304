...
public class Activity_Italian extends AppCompatActivity {
    private Intent intent;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity__italian);

        intent = new Intent(Activity_Italian.this, ActivityItalianMap.class);
        ...
        ListView lv = (ListView)findViewById(R.id.listView_italian);
        final  String[] restNames = getResources().getStringArray(R.array.italian_cuisines);
